...
public interface BookRepository extends JpaRepository<Book, Long> {
       ...
       Long countByUserAndStatusNot(@Param("user") User user, @Param("status") Book.BookStatus status);

       @Query("SELECT COUNT(b) FROM Book b WHERE b.status != 'DELETED'")
       Long countAllBooksNotDeleted();
}
