    ...
    public ResponseEntity<?> createOrder(
        ...
        try {
            ...
            String deliveryPhone = orderRequest.get("deliveryPhone") != null
                    ? orderRequest.get("deliveryPhone").toString()
                    : null;
            String deliveryNotes = orderRequest.get("deliveryNotes") != null
                    ? orderRequest.get("deliveryNotes").toString()
                    : null;

            Order order = orderService.createOrderFromCart(userOpt.get(), deliveryAddress, deliveryPhone,
                    deliveryNotes);
